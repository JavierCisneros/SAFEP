...
public class PreguntaAdapterA extends RecyclerView.Adapter<PreguntaAdapterA.ViewHolder> implements View.OnClickListener {
    ...
    public PreguntaAdapterA(ArrayList<Preguntas> preguntalist, ArrayList<Calificaciones> calificacioneslist, ArrayList<Usuario> usuarioslist, int resource){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int index) {
        ...
        holder.tvId.setText(ForoA.idListA.get(index));
        holder.tvUsuario.setText(usuario.getUsuario());
        holder.tvCal.setText(ForoA.sCalA.get(index));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        private TextView tvPregunta,tvCal,tvId,tvUsuario,tvRcCal;
