...
public class RespuestaAdapterA extends RecyclerView.Adapter<RespuestaAdapterA.ViewHolder> implements View.OnClickListener {
    ...
    public RespuestaAdapterA(ArrayList<Respuestas> preguntalist,ArrayList<Calificaciones> calificacioneslist,ArrayList<Usuario> usuarioslist, int resource){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int index) {
        ...
        holder.tvRcId.setText(RespuestaA.ridList.get(index).toString());
        holder.tvUsuario.setText(usuario.getUsuario());
        holder.tvRcCal.setText(RespuestaA.sCalRA.get(index).toString());
    }
