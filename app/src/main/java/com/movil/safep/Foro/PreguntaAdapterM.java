...
import com.movil.safep.MisPA;
import com.movil.safep.R;

import java.util.ArrayList;

public class PreguntaAdapterM extends RecyclerView.Adapter<PreguntaAdapterM.ViewHolder> implements View.OnClickListener {
    ...
    public PreguntaAdapterM(ArrayList<Preguntas> preguntalist, ArrayList<Calificaciones> calificacioneslist, ArrayList<Usuario> usuarioslist, int resource){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int index) {
        ...
        holder.tvId.setText(Mispreguntas.idList.get(index));
        holder.tvUsuario.setText(usuario.getUsuario());
        holder.tvCal.setText(Mispreguntas.sCalI.get(index));
