...
import com.movil.safep.ui.send.SendViewModel;
...
public class Mispreguntas extends AppCompatActivity {
    ...
    private PreguntaAdapterM pAdapter;
    ...
    public static ArrayList<String> sCalMI = new ArrayList<>();
    int uno=0;
    int cero=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pAdapter = new PreguntaAdapterM(pList,cList,nameList,R.layout.pregunta_view);
        ...
        pAdapter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(Mispreguntas.this);
                builder.setTitle("Tema: \t"+pList.get(a).toString());
                builder.setItems(items, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int item) {
                        Toast.makeText(Mispreguntas.this, ""+items[item], Toast.LENGTH_SHORT).show();
                        if(items[item].equals(items[0])){
                           ...
                           final Intent a = new Intent(Mispreguntas.this, MisRespuestas.class);
                            startActivity(a);
                        }
                    }
                });
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String in="inversion";
                    for (int i = 0; i < idListUno.size(); i++) {
                        mDatabase.child("Users").child("foro" + date).child("inversion").child("" + idListUno.get(i)).addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()) {
            ...
            mDatabase1.child("Users").child("foro" + date).child("inversion").child("" + idList.get(i)).child("pregunta").child("cal").addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        sCalMI.add(" Buena: "+uno+"Mala: "+cero);
                        uno = 0;
                        cero = 0;
                        pRecyclerView.setAdapter(pAdapter);
                    }
