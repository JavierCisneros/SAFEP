...
public class RespuestaAdapterM extends RecyclerView.Adapter<RespuestaAdapterM.ViewHolder> implements View.OnClickListener {
    ...
    public RespuestaAdapterM(ArrayList<Respuestas> preguntalist,ArrayList<Calificaciones> calificacioneslist,ArrayList<Usuario> usuarioslist, int resource){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int index) {
        ...
        holder.tvRcId.setText(MisRespuestas.ridList.get(index).toString());
        holder.tvUsuario.setText(usuario.getUsuario());
        holder.tvRcCal.setText(MisRespuestas.sCalRMI.get(index).toString());
    }
