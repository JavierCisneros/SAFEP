...
import com.movil.safep.Foro.RespuestaAdapterM;
...
public class MisRA extends AppCompatActivity {

    private ImageView atras;
    private TextView tvPregunta,tvCalificacion,tvId;
    private RecyclerView rRecyclerView;
    private RespuestaMisA rAdapter;
    ...
    int uno=0;
    int cero=0;
    public static ArrayList<String> sCalR = new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mis_r);
        atras= findViewById(R.id.btAtrasMR);
        tvPregunta = findViewById(R.id.tvPreResMR);
        tvId = findViewById(R.id.tvIdRMR);
        tvPregunta.setText(""+ MisPA.pregunta);
        tvId.setText(""+MisPA.idPregunta);
        rRecyclerView = findViewById(R.id.RcRespuestasMR);
        rRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        rAdapter = new RespuestaMisA(rList,rcList,nameList,R.layout.respuesta_view);
