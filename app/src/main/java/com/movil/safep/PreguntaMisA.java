...
import com.movil.safep.Foro.Preguntas;
import com.movil.safep.Foro.RespuestaA;
import com.movil.safep.Foro.Usuario;

import java.util.ArrayList;

public class PreguntaMisA extends RecyclerView.Adapter<PreguntaMisA.ViewHolder> implements View.OnClickListener  {
    ...
    public PreguntaMisA(ArrayList<Preguntas> preguntalist, ArrayList<Calificaciones> calificacioneslist, ArrayList<Usuario> usuarioslist, int resource){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int index) {
        ...
        holder.tvId.setText(MisPA.idList.get(index));
        holder.tvUsuario.setText(usuario.getUsuario());
        holder.tvCal.setText(MisPA.sCal.get(index));
