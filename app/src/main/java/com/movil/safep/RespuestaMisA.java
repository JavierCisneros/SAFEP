...
import com.movil.safep.Foro.Calificaciones;
import com.movil.safep.Foro.MisRespuestas;
import com.movil.safep.Foro.RespuestaA;
import com.movil.safep.Foro.Respuestas;
import com.movil.safep.Foro.Usuario;

import java.util.ArrayList;

public class RespuestaMisA  extends RecyclerView.Adapter<RespuestaMisA.ViewHolder> implements View.OnClickListener  {
    ...
    public RespuestaMisA(ArrayList<Respuestas> preguntalist,ArrayList<Calificaciones> calificacioneslist,ArrayList<Usuario> usuarioslist, int resource){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int index) {
        ...
        holder.tvRcId.setText(MisRA.ridList.get(index).toString());
        holder.tvUsuario.setText(usuario.getUsuario());
        holder.tvRcCal.setText(MisRA.sCalR.get(index).toString());
    }
